...
export default function AddBusinessForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div><label className={labelClass} htmlFor="gbp_url">Google Business Profile URL <span className="text-gray-400">(optional)</span></label><input id="gbp_url" type="text" inputMode="url" placeholder="https://maps.app.goo.gl/..." value={form.gbp_url} onChange={(e) => set("gbp_url", e.target.value)} className={inputClass} /><p className="text-xs text-gray-500 mt-1">Optional. If you add it we can pull your reviews and photos, and match you to an existing listing more accurately. It is not proof of ownership.</p></div>
